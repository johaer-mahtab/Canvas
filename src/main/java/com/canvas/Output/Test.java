...
public class Test {
    ...
    public static void tsts1() {
        Current.getUserDB().addNewStudent("012", "p", "Abc", 22);
        Current.getUserDB().addNewStudent("123", "p", "Abc", 2);
        ...
        try {
            ...
            f.createNewCourse("CSE115", 7, 3, "SAC214", "MW 10:20-11:30");
            f.displayInfo();
